...
st.title("ACAC Net-pts WAR (oWAR / dWAR) — Season Leaderboard")
...
sort_choice = st.segmented_control("Sort By", ["Offense","Defense","Total"], default="Total")
order_col = {"Offense": o_col, "Defense": d_col, "Total": t_col}[sort_choice]
dfv = dfv.sort_values(order_col, ascending=False)

show_cols = ["player_name","team_name","pos","class","poss_for","OffRtg_on","DefRtg_on", o_col, d_col, t_col]
ren = {"player_name":"PLAYER","team_name":"TEAM","pos":"POS","class":"CLASS",
       "poss_for":"ON-COURT POSS","OffRtg_on":"OFF Rtg (on)","DefRtg_on":"DEF Rtg (on)",
